    ...
    <div className="max-w-md mx-auto my-12 px-4 animate-fade-in">
      ...
      <div className="text-center mb-8 space-y-4">
        <div className="relative w-20 h-20 mx-auto flex items-center justify-center">
          ...
          <div className="w-16 h-16 bg-[#C0FF38] rounded-2xl flex items-center justify-center shadow-[0_0_25px_rgba(192,255,56,0.25)]">
            <Sparkles className="w-8 h-8 text-[#000204]" />
          </div>
        </div>

        <div className="space-y-1">
          <h1 className="font-display text-4xl font-black tracking-tight text-white uppercase">
            Raiku Quiz Event
          </h1>
      ...
      {!showAdminLogin ? (
        <div className="p-6 md:p-8 bg-[#0A0E12] border border-[#C0FF38]/15 rounded-2xl space-y-6 shadow-[0_12px_40px_rgba(0,0,0,0.6)]">
          ...
          <form onSubmit={handleJoin} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-[#040608] border border-white/10 focus:border-[#C0FF38] focus:ring-1 focus:ring-[#C0FF38]/20 rounded-xl px-4 py-3 text-lg font-mono font-bold tracking-widest text-center text-white outline-none transition-all placeholder:text-slate-600"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-[#040608] border border-white/10 focus:border-[#C0FF38] focus:ring-1 focus:ring-[#C0FF38]/20 rounded-xl px-4 py-3.5 text-sm text-slate-100 outline-none transition-all font-mono placeholder:text-slate-600"
              />
            </div>
          ...
          <form onSubmit={handleAdminLoginSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-[#040608] border border-white/10 focus:border-[#C0FF38] focus:ring-1 focus:ring-[#C0FF38]/20 rounded-xl px-4 py-3.5 text-center text-white outline-none tracking-widest transition-all font-mono placeholder:text-slate-600"
              />
            </div>
